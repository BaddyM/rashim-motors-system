...
import { Search, Plus, Car, Edit, Trash2, LayoutGrid, LayoutList } from "lucide-react";
      ...
      <div className="grid grid-cols-2 gap-4 mt-4">
        ...
        <div>
          ...
          <div className="mt-2 space-y-2">
            ...
            <p><strong>Stock:</strong> {vehicle.stock} units</p>
            <p><strong>Status:</strong> <Badge className={getStockStatus(vehicle.stock).color}>{getStockStatus(vehicle.stock).label}</Badge></p>
          </div>
        </div>
      </div>
    </DialogContent>
